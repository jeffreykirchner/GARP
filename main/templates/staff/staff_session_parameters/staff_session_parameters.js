...
let app = Vue.createApp({
    ...
    data() {return {chat_socket : "",
                    ...
                    current_parameter_set_consumer_price : {
                        id:0,
                    },
                    ...
                    edit_parameterset_consumer_price_modal : null,
    ...
    methods: {
        ...
        */
        ...
        do_first_load: function do_first_load()
        {
            ...
            app.edit_parameterset_consumer_price_modal = bootstrap.Modal.getOrCreateInstance(document.getElementById('edit_parameterset_consumer_price_modal'), {keyboard: false})
        ...
        */
        ...
        {%include "staff/staff_session_parameters/consumer_prices/consumer_prices.js"%}
