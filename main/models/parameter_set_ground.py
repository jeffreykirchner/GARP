...
class ParameterSetGround(models.Model):
    ...
    render_order = models.IntegerField(verbose_name='Render Order', default=0)                     #order in which ground elements are rendered
    enable_clipping = models.BooleanField(verbose_name='Enable Clipping', default=False)           #prevents avatars from overlapping this element
